<?php	
	...
	function processRepositoryRecord($item, &$sourceReport = '')
	{
		...
		{		
			...
			$recordType = saveSourceData($sourceReport, $source, $idInSource, $sourceData, 'XML');
								...
								{									
									...
									{		
										if((string)$bitstreamField[0]['name']==='url')
										{
											...
											$bitstreamURLRowID = mapTransformSave($source, $idInSource, '', $field, '', $place, $value, NULL);											
										}
									}
									...
									{		
										...
										$value = (string)$bitstreamField;
										$rowID = mapTransformSave($source, $idInSource, '', $field, '', $childPlace, $value, $bitstreamURLRowID);
										$currentBitstreamFields[] = $field;
									}
									
									$field = 'dspace.bitstream.bundleName';
									$rowID = mapTransformSave($source, $idInSource, '', $field, '', $childPlace, 'ORIGINAL', $bitstreamURLRowID);
									$currentBitstreamFields[] = $field;
